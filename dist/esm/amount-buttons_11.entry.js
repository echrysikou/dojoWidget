import { g as getRenderingRef, f as forceUpdate, r as registerInstance, h, a as getElement, H as Host, E as Env } from './index-fdeffe27.js';
...
const StripePayment = class {
    ...
    render() {
        ...
        return (h(Host, null, h("div", { class: "stripe-container" }, h("app-typography", { variant: "secondaryP", fontFamily: font, styleProps: {
                fontWeight: '700',
            } }, instance.t('choosePaymentMethod')), h("form", { id: "payment-form", class: "stripe-form", onSubmit: event => handleSubmit(event) }, h("div", { id: "payment-element" }), h("button", { title: !state.stripe.paymentElementIntentAmount || !state.stripe.amountIsValid ? instance.t('missingAmount') : '', class: "stripe-pay-button", disabled: this.isLoading || !this.stripe || !this.elements || !state.stripe.paymentElementIntentAmount || !state.stripe.amountIsValid || this.disablePayButton, id: "submit", style: {
                backgroundColor: secondaryColor,
                color: getContrastColor(secondaryColor).blackOrWhite,
                transform: this.isHovered ? 'scale(1.01)' : 'none',
            }, onMouseOver: () => (this.isHovered = true), onMouseOut: () => (this.isHovered = false) }, this.isLoading ? h("app-loader", { height: 25, color: getContrastColor(secondaryColor).blackOrWhite }) : instance.t('payNow')), h("div", { id: "error-message" }, h("app-typography", { variant: "secondaryP", class: "stripe-error", fontFamily: font, style: { color: getSafeDangerColor(primaryColor) } }, this.errorMsg))))));
    }
};
...
export { AmountButtons$1 as amount_buttons, AmountInput as amount_input, AppLoader as app_loader, Typography as app_typography, ButtonWidget as button_widget, CollaboratorsList as collaborators_list, FullWidget as full_widget, QrCodeWidget as qr_code_widget, AmountButtons as select_amount, StripePayment as stripe_payment, WidgetSelector as tt_widget };

//# sourceMappingURL=amount-buttons_11.entry.js.map