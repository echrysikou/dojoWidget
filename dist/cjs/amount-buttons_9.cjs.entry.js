...
const AmountButtons$1 = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '59c95a19e835085d6cc0d3d3e172612fc8ea39b3', class: "select-amount-container" }, index.h("app-typography", { key: '3457d31c0af4987e0f9e0635583c8f7fa022ca2f', variant: "secondaryP", fontFamily: font, styleProps: {
                fontWeight: '700',
            } }, instance.t('selectAmount')), index.h("div", { key: 'a2260639d4f21e991ada6645bbb44396be23dfa9', class: "amount-btns-container" }, btnAmounts.map(amount => {
...
const AmountInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4ba263a37d2c2edb17a11d9da2416d45520925df', class: "enter-amount-container" }, index.h("app-typography", { key: 'cd48619a9404ce2b8c896b11a006dad575218753', variant: "secondaryCaption", fontFamily: font.includes('Baloo Bhaijaan 2') ? 'Raleway, sans-serif' : font, styleProps: {
                fontWeight: '500',
            } }, instance.t('enterAmount')), index.h("div", { key: 'aac977ad06e6bd8ba4b6ae7fa11ee6f47f64aacc', class: "form-control", onMouseOver: () => (this.isHovered = true), onMouseOut: () => (this.isHovered = false), style: { height: '56px' } }, index.h("div", { key: '1c079b7924e6c2c0cb614e7c571a6d606025f1d1', class: "input-container", style: { border: `${this.isHovered ? '2px' : '0.5px'} solid ${secondaryColor}`, height: '56px' } }, index.h("span", { key: 'f01cb6f1c9629072553c91ea30d8f2fae5709f73', class: "input-adornment", style: { fontFamily: font } }, "\u20AC"), index.h("input", { key: 'faf85c3be9c254f0f7cdc85151f8931f5333ab8e', id: `outlined-adornment-amount${this.selectedAmount}`, ref: el => (this.inputRef = el), style: { fontFamily: font }, type: "number", onInput: event => this.handleInput(event), step: "0.01", min: "1", value: this.selectedAmount })), this.amountTooLow && (index.h("app-typography", { key: '5e4a29602f39b809d2cc7118c7437c4061f5bb3d', variant: "secondaryMessage", class: "low-amount-error", style: { color: getSafeDangerColor(bgColor) } }, instance.t('minStripeAmount'))))));
    }
...
const Typography = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '22140afc88d5dd9d2cdcb81c22e7bfb58435997e', class: `typography ${this.variant}`, style: Object.assign({ fontFamily: font }, this.styleProps) }, index.h("slot", { key: '0340e003737daa1ba6f0aaa62fd5d450d3da4b35' })));
    }
};
...
const ButtonWidget = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b677bc40b2777455bcc662c40ea8135f7ec6d4b5' }, index.h("button", { key: 'db6ebc38575c064e4f06fa515374138c576d3876', class: "donate-button", style: {
            ...
            }, onClick: this.handleClick }, index.h("span", { key: '7d2d0f194ef169b569f2c83539357872331f0dcc', class: "taktak-icon" }, index.h("img", { key: 'f3bab5b3bd3f73ddb7b1e9e9cfe138f6f5cdfad6', src: imageSrc, alt: "Taktak Icon", class: "t-icon-image" })), index.h("span", { key: 'd0b7ad0c671907bad5c80037b922e123c0bdfec3', class: "button-text" }, state.widgetDetails.label))));
    }
...
const CollaboratorsList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '85dec3eda2a519000d14bba4a0a22f72eb660977', class: "collaborators-container" }, index.h("app-typography", { key: 'd1e1f9e2a53f7767fe7f157453384117cb6cebc8', variant: "secondaryP", fontFamily: font, styleProps: { fontWeight: '700' } }, "Collaborators"), index.h("div", { key: 'a14c95e2471ec039ec948941f68f3b5ea4c267de', class: "collaborators", style: { justifyContent: collaborators.length === 1 ? 'center' : collaborators.length === 2 ? 'space-around' : 'space-between' } }, collaborators.map((collaborator) => {
            var _a;
            ...
            return (index.h("div", { key: collaborator.id, class: "collaborator-stack" }, index.h("app-typography", { variant: "secondaryP", fontFamily: font, styleProps: {
                    textAlign: 'center',
                    marginLeft: '8px',
                } }, (collaborator === null || collaborator === void 0 ? void 0 : collaborator.share) ? collaborator.share * 100 : 0, " %"), index.h("div", { class: "avatar-container" }, ((_a = collaborator === null || collaborator === void 0 ? void 0 : collaborator.profile) === null || _a === void 0 ? void 0 : _a.image) ? (index.h("img", { class: "avatar-image", src: collaborator.profile.image, alt: name + ' ' + surname })) : (index.h("div", { class: "avatar-initials" }, index.h("app-typography", { variant: "body1", fontFamily: 'var(--font-primary)', styleProps: { fontSize: '35px', marginBottom: '-5px' } }, initials)))), index.h("app-typography", { variant: "secondaryCaption", fontFamily: font, styleProps: {
                    fontWeight: 500,
                    textAlign: 'center',
                    marginTop: '8px',
        ...
        })), index.h("div", { key: '62f80ae90567141d6fef9ce82796ee0d30008a8e', class: "fee-container" }, index.h("app-typography", { key: '3304bd0f458aed5713af3b025e8731c1c953bb0f', variant: "secondaryMessage", fontFamily: font, styleProps: {
...
const FullWidget = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3d504166c10922a88fdf860ca47cee521ee1a936' }, index.h("div", { key: '337fccc77b9c45d392a0a2244b1feaae15e4488f', class: "widget-container", style: {
                backgroundColor: themeColor,
                color: state.widgetDetails.fontColor,
            } }, index.h("img", { key: 'a848775d4cfad86a2f39d12159d4f268db0a61e7', src: logo, class: "taktak-logo", alt: "Taktak logo" }), index.h("app-typography", { key: '62b2c66cbaf96a9af590e6a5ecf81e8a2ac85aa1', variant: "h3", fontFamily: font, styleProps: { marginTop: '10px', height: '20px' } }, label), index.h("select-amount", { key: '677879ef708db5d77029e6e8c850804fb03f921b' }), index.h("collaborators-list", { key: '70040f6f93c3ce66b6dde7817a20a58c1b116a44' }))));
    }
};
...
const QrCodeWidget = class {
    ...
    render() {
        return (index.h(index.Host, { key: '57bb081c4968f99d01dfa89780b3f4961af213a3' }, index.h("div", { key: 'aaf7eb5f2dbe0077fdd15fe5fe5dc4233b6df260' }, "QR code")));
    }
};
...
const AmountButtons = class {
    ...
    render() {
        return (index.h("div", { key: 'ae9e341755d5091a9ba660a8a217c0acd677658c', class: "amount-container" }, index.h("amount-buttons", { key: 'cbe6eb3e36ac8537664b99a3953a9d1eccd9ac17' }), index.h("amount-input", { key: '4c3698f9f3a71c4c8e02691f9a2200481950e544' })));
    }
};
...
const WidgetSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '478b0d0e7d61d127934614b580b9fd87a077e3a6' }, this.renderWidget()));
    }
    static get watchers() { return {
        "lang": ["setLanguage"]
    }; }
...
//# sourceMappingURL=amount-buttons_9.cjs.entry.js.map