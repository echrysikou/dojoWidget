...
const selectAmount = "Select amount";
const enterAmount = "or enter amount";
const minStripeAmount = "Stripe only allows amounts greater than €1.00";
const transactionFeesPercentage = "{{percentage}} goes to transaction fees";
const choosePaymentMethod = "Choose a payment method";
const payNow = "Pay Now";
const validationError = "Some required fields are missing or incorrect. Please check and try again.";
const missingAmount = "Please select an amount first";
const en = {
	selectAmount: selectAmount,
	enterAmount: enterAmount,
	minStripeAmount: minStripeAmount,
...
instance.init({
    ...
    lng: state$1.language, // Default language
    fallbackLng: 'en',
    debug: true,
    interpolation: {
        escapeValue: false,
...
const setLanguage = (lang) => {
    ...
    state$1.language = lang; // Update the store
};
...
const capitalizeFirstCharOfEachWord = (text) => {
    return text
        .toLowerCase()
        .split(' ')
...
const areColorArraysEqual = (arr1, arr2) => arr1.length === arr2.length && arr1.every((val, index) => resolveCssVariable(val) === resolveCssVariable(arr2[index]));
...
const getWidgetButtonAndBorderColors = (primaryColor, secondaryColor) => {
    var _a, _b;
...
const AmountButtons$1 = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e871ca9262c4a36b0a7ff905efa8cbee82b6ca55', class: "select-amount-container" }, index.h("app-typography", { key: '9b62bba7a12f856488183273185914d73d53eca2', variant: "secondaryP", fontFamily: font, styleProps: {
                fontWeight: '700',
            } }, instance.t('selectAmount')), index.h("div", { key: '96631f545428fe779e50a756eebbed4fd7b73589', class: "amount-btns-container" }, btnAmounts.map(amount => {
            ...
            return (index.h("button", { key: `amount_${amount}_btn`, class: "widgetButton", onClick: () => updateAmount(amount), style: {
                    fontFamily: font,
...
const AmountInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '47a7b1de7236cc8a58ed1ed52cce3b93b4d6bc0b', class: "enter-amount-container" }, index.h("app-typography", { key: '86f11504143290b67943e9bc7eff7dd1453d4e1a', variant: "secondaryCaption", fontFamily: font.includes('Baloo Bhaijaan 2') ? 'Raleway, sans-serif' : font, styleProps: {
                fontWeight: '500',
            } }, instance.t('enterAmount')), index.h("div", { key: '1de04268f9c025dcfbecf828a283eeaf85289b0d', class: "form-control", onMouseOver: () => (this.isHovered = true), onMouseOut: () => (this.isHovered = false), style: { height: '56px' } }, index.h("div", { key: 'fe71ac6d984547fb0a0d5660c03dce0e0a9ce1fb', class: "input-container", style: { border: `${this.isHovered ? '2px' : '0.5px'} solid ${secondaryColor}`, height: '56px' } }, index.h("span", { key: '327860d11c724e592bd9f2d017ded94b30d42ad6', class: "input-adornment", style: { fontFamily: font } }, "\u20AC"), index.h("input", { key: '89faaa14125054bf28c09e8e07cf68ae1ff51035', id: `outlined-adornment-amount${this.selectedAmount}`, ref: el => (this.inputRef = el), style: { fontFamily: font }, type: "number", onInput: event => this.handleInput(event), step: "0.01", min: "1", value: this.selectedAmount })), this.amountTooLow && (index.h("app-typography", { key: 'eba50d24677ba8e6f67db01c93691a3ad0111ceb', variant: "secondaryMessage", class: "low-amount-error", style: { color: getSafeDangerColor(bgColor) } }, instance.t('minStripeAmount'))))));
    }
...
const AppLoader = class {
    ...
    render() {
        return (index.h("div", { key: 'f70c9a25ed99c648327e56d867713428dd46b74b', class: "loader-root" }, index.h("div", { key: 'eaba45ad983825410ead89511084039e8a1f1caa', class: "circular-progress", style: {
...
const Typography = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '7fba3365ec686c09c4080d280094554db31ab422', class: `typography ${this.variant}`, style: Object.assign({ fontFamily: font }, this.styleProps) }, index.h("slot", { key: '04ff3d6ed4da75d2f3b4e98f9a683bad8c04d159' })));
    }
};
...
const ButtonWidget = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.handleClick = () => {
            const url = index.Env.PLATFORM_URL + '/donate?id=' + state.widgetDetails.uuid;
            window.open(url, '_blank', 'noopener,noreferrer');
        };
    }
    render() {
        var _a;
        const imageSrc = index.Env.CDN_PATH + '/assets/t-icon.svg';
        return (index.h(index.Host, { key: '7531bd773ce9550dbad2375625a0b7a821468730' }, index.h("button", { key: '01fea570333ea2c53774bbf69d1cc58736145586', class: "donate-button", style: {
            ...
            }, onClick: this.handleClick }, index.h("span", { key: '1996928c1c48e5701933e181839fe7e24cc45ea9', class: "taktak-icon" }, index.h("img", { key: 'd823428fdde8c260b81ce19aac83c170cd67da28', src: imageSrc, alt: "Taktak Icon", class: "t-icon-image" })), index.h("span", { key: 'abcc2e4a43f36c642f96b916976a1d3c01aeff4a', class: "button-text" }, state.widgetDetails.label))));
    }
...
const CollaboratorsList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3e3ed8118e69d074eab9b6f74d2cc37e30147aa9', class: "collaborators-container" }, index.h("app-typography", { key: 'dce38bd47771b720e420e7f96c493ab6276bd02c', variant: "secondaryP", fontFamily: font, styleProps: { fontWeight: '700' } }, "Collaborators"), index.h("div", { key: 'ec495d9c3a0de95c68671045e8b46e49c2cca48b', class: "collaborators", style: { justifyContent: collaborators.length === 1 ? 'center' : collaborators.length === 2 ? 'space-around' : 'space-between' } }, collaborators.map((collaborator) => {
            var _a;
            const { name, surname, headline } = collaborator.profile;
            const initials = getAvatarInitials(name, surname);
            return (index.h("div", { key: collaborator.id, class: "collaborator-stack" }, index.h("app-typography", { variant: "secondaryP", fontFamily: font, styleProps: {
                    textAlign: 'center',
                    marginLeft: '8px',
                } }, (collaborator === null || collaborator === void 0 ? void 0 : collaborator.share) ? collaborator.share * 100 : 0, " %"), index.h("div", { class: "avatar-container", style: { backgroundColor: secondaryColor } }, ((_a = collaborator === null || collaborator === void 0 ? void 0 : collaborator.profile) === null || _a === void 0 ? void 0 : _a.image) ? (index.h("img", { class: "avatar-image", src: collaborator.profile.image, alt: name + ' ' + surname })) : (index.h("div", { class: "avatar-initials" }, index.h("app-typography", { variant: "body1", fontFamily: 'var(--font-primary)', styleProps: { fontSize: '35px', marginBottom: '-5px', backgroundColor: secondaryColor, color: getContrastColor(secondaryColor).blackOrWhite } }, initials)))), index.h("app-typography", { variant: "secondaryCaption", fontFamily: font, styleProps: {
                    fontWeight: 500,
                    textAlign: 'center',
                    marginTop: '8px',
                } }, capitalizeFirstCharOfEachWord(name !== null && name !== void 0 ? name : ''), " ", capitalizeFirstCharOfEachWord(surname !== null && surname !== void 0 ? surname : '')), index.h("app-typography", { variant: "secondaryMessage", fontFamily: font, style: {
                    textAlign: 'center',
                    marginTop: '-10px',
                    // color: professionColor, TODO: define color
                } }, capitalizeFirstCharOfEachWord(headline !== null && headline !== void 0 ? headline : ''))));
        })), index.h("div", { key: '7b61968a747edcc59c0d1310b80f06b6714273df', class: "fee-container" }, index.h("app-typography", { key: 'c9016ef92ae948cf1525d62dc98fa7fb57bc35a3', variant: "secondaryMessage", fontFamily: font, styleProps: {
...
CollaboratorsList.style = CollaboratorsListStyle0;
...
const FullWidget = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    render() {
        const logo = index.Env.CDN_PATH + '/assets/TaktakLogo.png';
        const { font, label, themeColor } = state.widgetDetails;
        return (index.h(index.Host, { key: 'c613da87739cb15d8b11c0bbed86911007caec1e' }, index.h("div", { key: 'fad1cc489c839f0c0dbe8a33fae12edff2db9ee3', class: "widget-container", style: {
                backgroundColor: themeColor,
                color: state.widgetDetails.fontColor,
            } }, index.h("img", { key: '0134d789461a82b0a903ad4c5a05038bb52b43b1', src: logo, class: "taktak-logo", alt: "Taktak logo" }), index.h("app-typography", { key: 'fba63a72ea38df6fed63279eb701569aa41ad19c', variant: "h3", fontFamily: font, styleProps: { marginTop: '10px', height: '20px' } }, label), index.h("select-amount", { key: '3b6b19a3c6b931d87c9085ddf50d7e0e93b16d89' }), index.h("collaborators-list", { key: '8ff247dd26250034a6037a557b0ff0eec53448f7' }), index.h("stripe-payment", { key: '9f7c52cbeecaae36e1d09c6dff923151dd842eed' }))));
    }
};
FullWidget.style = FullWidgetStyle0;

const qrCodeWidgetCss = "";
const QrCodeWidgetStyle0 = qrCodeWidgetCss;

const QrCodeWidget = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wId = undefined;
    }
    render() {
        return (index.h(index.Host, { key: '8eec98840e3d4f6593533bcee8c4fed8a48c4c8d' }, index.h("div", { key: 'd318457ec198cebaa9daab3a2c53a354ac82b881' }, "QR code")));
    }
};
QrCodeWidget.style = QrCodeWidgetStyle0;

const selectAmountCss = ".amount-container{margin-top:-5px}";
const SelectAmountStyle0 = selectAmountCss;

const AmountButtons = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    render() {
        return (index.h("div", { key: 'c13ff04ceb9c9361bf6ad9d01c877058df34a5d6', class: "amount-container" }, index.h("amount-buttons", { key: '317d346b3d0a38c0868e7c22e6070e3f25b37b00' }), index.h("amount-input", { key: '73092d60780c04ca45ccd31676ef1a7c9686f992' })));
    }
};
AmountButtons.style = SelectAmountStyle0;
...
const apiUrl = index.Env.API_URL;
async function fetchWidgetDetails(id) {
    const response = await axios$1.get(`${apiUrl}/elements/${id}`);
    return response.data;
}
async function createPaymentIntent({ amount, elementId }) {
    const response = await axios$1.post(`${apiUrl}/payment/intent`, { amount, elementId });
    return response.data;
}
...
const StripePayment = class {
    ...
    async componentDidLoad() {
        this.stripe = await loadStripe(index.Env.STRIPE_PUBLISHABLE_KEY);
        if (this.stripe) {
            const options = {
    ...
    render() {
        ...
        const handleError = error => {
            if (typeof error === 'string') {
                ...
                this.errorMsg = instance.t('validationError');
            }
        ...
        return (index.h(index.Host, null, index.h("div", { class: "stripe-container" }, index.h("app-typography", { variant: "secondaryP", fontFamily: font, styleProps: {
                fontWeight: '700',
            } }, instance.t('choosePaymentMethod')), index.h("form", { id: "payment-form", class: "stripe-form", onSubmit: event => handleSubmit(event) }, index.h("div", { id: "payment-element" }), index.h("button", { title: !state.stripe.paymentElementIntentAmount || !state.stripe.amountIsValid ? instance.t('missingAmount') : '', class: "stripe-pay-button", disabled: this.isLoading || !this.stripe || !this.elements || !state.stripe.paymentElementIntentAmount || !state.stripe.amountIsValid || this.disablePayButton, id: "submit", style: {
                backgroundColor: secondaryColor,
                color: getContrastColor(secondaryColor).blackOrWhite,
                transform: this.isHovered ? 'scale(1.01)' : 'none',
            }, onMouseOver: () => (this.isHovered = true), onMouseOut: () => (this.isHovered = false) }, this.isLoading ? index.h("app-loader", { height: 25, color: getContrastColor(secondaryColor).blackOrWhite }) : instance.t('payNow')), index.h("div", { id: "error-message" }, index.h("app-typography", { variant: "secondaryP", class: "stripe-error", fontFamily: font, style: { color: getSafeDangerColor(primaryColor) } }, this.errorMsg))))));
    }
};
StripePayment.style = StripePaymentStyle0;

const widgetSelectorCss = "";
const TtWidgetStyle0 = widgetSelectorCss;

const WidgetSelector = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wId = undefined;
        this.language = 'en';
    ...
    renderWidget() {
        ...
        if ((_a = this.data) === null || _a === void 0 ? void 0 : _a.type) {
            switch (this.data.type) {
                case 'WG':
                    return index.h("full-widget", null);
                case 'BT':
                    return index.h("button-widget", null);
                case 'QR':
                    return index.h("qr-code-widget", { wId: this.wId });
                default:
    ...
    render() {
        return (index.h(index.Host, { key: 'bacdcf4c062febf3f6d17dab0a9ff683afa502c3' }, this.renderWidget()));
    }
    static get watchers() { return {
        "lang": ["setLanguage"]
    }; }
};
WidgetSelector.style = TtWidgetStyle0;

exports.amount_buttons = AmountButtons$1;
exports.amount_input = AmountInput;
exports.app_loader = AppLoader;
exports.app_typography = Typography;
exports.button_widget = ButtonWidget;
exports.collaborators_list = CollaboratorsList;
exports.full_widget = FullWidget;
exports.qr_code_widget = QrCodeWidget;
exports.select_amount = AmountButtons;
exports.stripe_payment = StripePayment;
exports.tt_widget = WidgetSelector;

//# sourceMappingURL=amount-buttons_11.cjs.entry.js.map