...
export declare const getWidgetButtonAndBorderColors: (primaryColor: string, secondaryColor: string) => {
    buttonBgColor: string;
    elemBorderColor: string;
};
export declare const getStripeWidgetFontColor: (bgColor: string, fontClr: string) => string;
export declare const getStripeElementAppearance: (fontColor: string, primaryColor: string, secondaryColor: string) => Appearance;
